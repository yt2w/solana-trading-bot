...
# For Solana RPC calls - aggressive retry with exponential backoff
...
# For HTTP requests - moderate retry
...
# For transaction sending - conservative retry with longer delays
...
# For Jupiter API calls - moderate retry with quick initial attempts
...
# For database/cache operations - quick retry
...
# =============================================================================
# Retry Builder (Fluent Interface)
# =============================================================================
