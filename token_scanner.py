...
class RiskLevel(Enum):
    ...
    SAFE = "SAFE"           # 80-100 score
    CAUTION = "CAUTION"     # 50-79 score  
    DANGER = "DANGER"       # 20-49 score
    SCAM = "SCAM"           # 0-19 score or critical flags
...
# Known safe tokens (mainnet addresses)
